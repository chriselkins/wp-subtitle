...
class WPSubtitle_Term {
	...
	public function get_meta_value() {
		...
		return get_term_meta( $this->term_id, $this->get_meta_key(), true );
	...
	public function update_subtitle( $subtitle ) {
		...
		return update_term_meta( $this->term_id, $this->get_meta_key(), $subtitle );
